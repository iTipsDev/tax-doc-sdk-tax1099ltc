# tax-doc-sdk-tax1099ltc

Software development kit to generate IRS Form 1099-LTC as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Ltc.sample.png" width="850"/>
