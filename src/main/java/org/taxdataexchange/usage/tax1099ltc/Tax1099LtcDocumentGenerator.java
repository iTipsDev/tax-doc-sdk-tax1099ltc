...
import irs.fdxtax641.jsonserializers.Tax1099LtcSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Ltc;
import org.taxdataexchange.core.pdfbuilders.Tax1099LtcPdfBuilder;
...
public class Tax1099LtcDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Ltc obj = Map2Tax1099Ltc.generate( row );
        {
            String asJson = Tax1099LtcSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Ltc.csv";
        ...
        String outputFileName = "Tax1099Ltc.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099LtcDocumentGenerator generator = new Tax1099LtcDocumentGenerator( );
